/* ---------------------------------------------
expandAll v.1.3.8.2
https://web.archive.org/web/20170221222351/http://www.adipalaz.com/experiments/jquery/expand.html
    ...
    return this.each(function(index) {
       ...
       (o.switchPosition == 'before') ? ($.fn.findSibling = $.fn.prev, $.fn.insrt = $.fn.before) : ($.fn.findSibling = $.fn.next, $.fn.insrt = $.fn.after);
        ...
        if (o.localLinks) { 
          ...
          if (localLink.length) {
            // based on https://web.archive.org/web/20170221222351/http://www.learningjquery.com/2007/10/improved-animated-scrolling-script-for-same-page-links:
        ...
        -------------------------------------------------- */
        //web.archive.org/web/20170221222351/http://http://www.learningjquery.com/2007/10/improved-animated-scrolling-script-for-same-page-links:
...
$.fn.toggler.defaults = {
     ...
     method : 'slideToggle',
     speed : 'slow',
     container : '', //web.archive.org/web/20170221222351/http://the common container of all groups with collapsible content (optional)
     initShow : '.shown' //web.archive.org/web/20170221222351/http://the initially expanded sections (optional)
};
/* ---------------------------------------------
